...
\paragraph{} For a higher modulus such as 7, we can get eigenvectors corresponding to different eigenvalues as shown in Figure \ref{eig777all}.  Note that the corresponding solution of presses to clear the board is -1 times the eigenvector mod 7.  In other words, you would have to press the buttons as specified 6 times to cycle around to a blank board.
